...
| Parâmetro  | Descrição                                                                                                                                                                      |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `cenario`  | Estado atual do Relay (throughput, pico, retenção, consumidores) e restrições do time (SLAs, orçamento, zero perda). Cole o bloco completo no lugar de `{{cenario}}`. |
